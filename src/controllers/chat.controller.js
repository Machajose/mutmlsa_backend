...
- Upcoming events: the Welcome & Recruitment Drive for first-years
 ...
 your main purpose.
 If someone asks where a specific room, lab, or office is located on campus, mention that MUTMLSA doesn't have that in this chat, but direct them to the [campus lecture-room finder](https://mut-lecture-rooms.vercel.app/) for room locations.
`;
